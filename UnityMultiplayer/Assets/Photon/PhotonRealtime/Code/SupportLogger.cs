...
namespace Photon.Realtime
{
    ...
    #endif
    {
        ...
        public void OnRoomListUpdate(List<RoomInfo> changedRoomList)
        {
			Debug.Log(this.GetFormattedTimestamp() + " SupportLogger OnRoomListUpdate(roomList). roomList.Count: " + changedRoomList.Count);
        }
